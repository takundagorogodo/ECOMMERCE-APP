...
router.put("/admin/update", authenticate ,allowRoles("admin"),updateAdmin);
router.put("/admin/delete-customer", authenticate ,allowRoles("admin"),deleteCustomerByAdmin);

router.patch("/customer/update",authenticate,allowRoles("customer"),updateCustomerDetails);
router.put("/customer/delete",authenticate, allowRoles("customer"),deleteCustomerAccount);
